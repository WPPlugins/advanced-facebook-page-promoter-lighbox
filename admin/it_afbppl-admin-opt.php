		...
		<?php do_settings_sections( 'it_afbppl-global-settings-group' ); ?>
			...
			<div class="plugin-pro">
				<div class="plugin-pro-ft">
						<?php _e('If you want to hire a wordpress expert for any modification over your website, So hire an expert today','it_afbppl');?><a href="http://plingoo.com/contact/" target="_blank" class="hire-btn">
							<?php _e('Hire Us Today!','it_afbppl');?>
						</a>
						<a href="http://forum.plingoo.com" target="_blank" class="button button-secondary">
			...
			<section>
				<div class="tabs tabs-style-underline">
					...
					<div class="content-wrap">
						...
						<a href="<?php  echo 'http://plingoo.com/contact/';?>" target="_blank" class="button button-primary"><?php _e('Click Here To Contact','it_afbppl');?></a>
						</section>
					</div><!-- /content -->		
				</div><!-- /tabs -->
				<footer>
					<p><?php _e('This Plugin is Developed &amp; Designed By','it_afbppl');?> <a href="<?php echo 'http://plingoo.com/?ref=afbppl';?>" target="_blank"><?php _e('Plingoo','it_afbppl');?></a></p>
					<?php submit_button(); ?>
				</footer>
			</section>
		</div>
